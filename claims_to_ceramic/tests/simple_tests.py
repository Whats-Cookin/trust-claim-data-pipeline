...
class TestPublishClaim(unittest.TestCase):
    ...
    def test_publish_claim(self, mock_update_claim_address, mock_run_publish):
        ...
        mock_update_claim_address.assert_called_once_with(
            "claim_id",
            "kjzl6kcym7w8y6eknw5isnnxezsby9gq5tuaqbyeysjeidqerg4jvqvd2fepsz9",
        )
    ...
    def test_extract_stream_id(self):
        ...
        self.assertEqual(
            stream_id, "kjzl6kcym7w8y6eknw5isnnxezsby9gq5tuaqbyeysjeidqerg4jvqvd2fepsz9"
        )
